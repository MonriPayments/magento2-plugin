...
namespace Monri\Payments\Controller\GooglePay\Form;
...
class Data extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $result = $payment->getAdditionalInformation(PaymentCreateHandler::INITIAL_DATA);
            $storeId = $order->getStoreId();

            $resultJson->setData([
                'payload' => $result,
                'url' => $this->config->getGatewayPaymentCreateURL($storeId),
