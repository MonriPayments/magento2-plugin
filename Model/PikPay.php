...
class PikPay extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    public function responseCodes()
    {
        ...
        $codes = [
            0000 => __("Transaction Approved"),
            1001 => __("Card Expired"),
            1002 => __("Card Suspicious"),
            1003 => __("Card Suspended"),
            1004 => __("Card Stolen"),
            1005 => __("Card Lost"),
            1011 => __("Card Not Found"),
            1012 => __("Cardholder Not Found"),
            1014 => __("Account Not Found"),
            1015 => __("Invalid Request"),
            1016 => __("Not Sufficient Funds"),
            1017 => __("Previously Reversed"),
            1018 => __("Previously Reversed"),
            1019 => __("Further activity prevents reversal"),
            1020 => __("Further activity prevents void"),
            1021 => __("Original transaction has been voided"),
            1022 => __("Preauthorization is not allowed for this card"),
            1023 => __("Only full 3D authentication is allowed for this card"),
            1024 => __("Installments are not allowed for this card"),
            1025 => __("Transaction with installments can not be send as preauthorization"),
            1026 => __("Installments are not allowed for non ZABA cards"),
            1050 => __("Transaction declined"),
            1802 => __("Missing fields"),
            1803 => __("Extra fields exist"),
            1804 => __("Invalid card number"),
            1806 => __("Card not active"),
            1808 => __("Card not configured"),
            1810 => __("Invalid amount"),
            1811 => __("System Error, Database"),
            1812 => __("System Error, Transaction"),
            1813 => __("Cardholder not active"),
            1814 => __("Cardholder not configured"),
            1815 => __("Cardholder expired"),
            1816 => __("Original not found"),
            1817 => __("Usage Limit Reached"),
            1818 => __("Configuration error"),
            1819 => __("Invalid terminal"),
            1820 => __("Inactive terminal"),
            1821 => __("Invalid merchant"),
            1822 => __("Duplicate entity"),
            1823 => __("Invalid Acquirer"),
            2000 => __("Internal error - host down"),
            2001 => __("Internal error - host timeout"),
            2002 => __("Internal error - invalid message"),
            2003 => __("Internal error - message format error"),
            2013 => __("3D Secure error - invalid request"),
            3000 => __("Time expired"),
            3100 => __("Function not supported"),
            3200 => __("Timeout"),
            3201 => __("Authorization host not active"),
            3202 => __("System not ready"),
            4001 => __("3D Secure error - ECI 7"),
            4002 => __("3D Secure error - not 3D Secure, store policy"),
            4003 => __("3D secure error - not authenticated"),
            5018 => __("RISK: Minimum amount per transaction"),
            5019 => __("RISK: Maximum amount per transaction"),
            5001 => __("RISK: Number of repeats per PAN"),
            5020 => __("RISK: Number of approved transactions per PAN"),
            5003 => __("RISK: Number of repeats per BIN"),
            5016 => __("RISK: Total sum on amount"),
            5021 => __("RISK: Sum on amount of approved transactions per PAN"),
            5022 => __("RISK: Sum on amount of approved transactions per BIN"),
            5005 => __("RISK: Percentage of declined transactions"),
            5009 => __("RISK: Number of chargebacks"),
            5010 => __("RISK: Sum on amount of chargebacks"),
            5006 => __("RISK: Number of refunded transactions"),
            5007 => __("RISK: Percentage increment of sum on amount of refunded transactions"),
            5023 => __("RISK: Number of approved transactions per PAN and MCC on amount"),
            5011 => __("RISK: Number of retrieval requests"),
            5012 => __("RISK: Sum on amount of retrieval requests"),
            5013 => __("RISK: Average amount per transaction"),
            5014 => __("RISK: Percentage increment of average amount per transaction"),
            5015 => __("RISK: Percentage increment of number of transactions"),
            5017 => __("RISK: Percentage increment of total sum on amount"),
            5050 => __("RISK: Number of repeats per IP"),
            5051 => __("RISK: Number of repeats per cardholder name"),
            5052 => __("RISK: Number of repeats per cardholder e-mail"),
            6000 => __("Internal error - systan mismatch"),
        ];
